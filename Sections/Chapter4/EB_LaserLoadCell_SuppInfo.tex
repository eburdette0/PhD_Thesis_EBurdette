...
\subsection{Vibrometer Modifications}
    A vibrometer can easily be incorporated into the design of the interferometer if optocouplers and another leg are added to mix returning light with the incident, modulated signal. The sensor face needs and anti-reflective coating to avoid Fabry-Perot effects. I-Q demodulation can be used to track the position of the reflector to higher speeds.
