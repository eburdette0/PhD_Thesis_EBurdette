...
\section{Dehydrating Creep Data}
...
\begin{figure}
  ...
  \caption{Antigorite creep data including partially dehydrating data.
  }
  \label{fig:CH2a_MechData_w620}
\end{figure}
\begin{figure}
  \includegraphics[width=\textwidth]{Sections/Chapter2/Figures/W2446_Stress-Strainrate-time.pdf}
  \caption{Stress (black), and strain rate (red) during creep of antigorite at 620°C. Gray box highlights stick-slip event.
  }
...
\begin{figure}
  ...
  \caption{A zoomed in plot of stress over time showing stick slip events during antigorite creep that lead to a fault visible in recovered sections.
  }
