...
\begin{figure}
  ...
  \caption[Compilation of our stress-strainrate points and other comparable tests]{
...
\begin{figure}
  ...
  \caption[Experiment data from 200°C experiment]{Experiment data from 200°C experiment. black->stress; red->strainrate; cyan->strain (log scale).
  }
...
\subsection{Flow Law Fit Methodology} \label{CH2s_flowlawfit}
    A Peierls' flow law was fit to stress vs. log(strainrate) using a Markov-chain Monte-Carlo (MCMC-NUTS) optimizer due to the small local discontinuities in the fit. Results with errors are presented in Table \ref{tab:CH2s_FitTab} and figure S\ref{fig:CH2s_KDE_plot}.
    \begin{table}[ht]
...
\begin{figure}
  ...
  \caption[Peierls' Fit improvement with low strain rate data]{Comparison of fits for fixed exponent p,q combinations before and after slow data is added to the dataset (for illustration). Slow strain rate data has a very strong effect on extrapolated viscosity.}
...
\begin{figure}
  ...
  \caption[Friction testing of the modified carbide bushing in paraffin wax]{Tests comparing old mitre ring seals to new carbide bushing seal friction during run-in through paraffin wax, and during deformation in contact with the grade 360 brass. Improvement in both static friction and rate dependent friction is 3-5x. Viscosity of run-in or “hit” material affects friction determination (lower zoomed rate steps).
  }
